...
export default function HomeMap() {
  return (
    <div className="w-full flex flex-col items-center gap-8 lg:min-h-96 lg:h-[600px] pt-16">
      <TypographyH2 className="container text-center">Where to find us?</TypographyH2>
