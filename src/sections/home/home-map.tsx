...
export default function HomeMap() {
  return (
    <div className="w-full flex flex-col gap-4 min-h-96 lg:h-[600px] pt-4 rounded-tl-3xl rounded-br-3xl">
      <TypographyH2>Where to find us?</TypographyH2>

      <div
        className="flex grow w-full shadow-2xl shadow-primary p-8 rounded-tl-3xl rounded-br-3xl"
        // style={{
      ...
      >
        <iframe
          ...
          className="border-none w-full h-full rounded-tl-2xl rounded-br-2xl"
          allowFullScreen
          loading="lazy"
