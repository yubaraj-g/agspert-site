...
export default function HomeMap() {
  return (
    <div className="w-full flex flex-col gap-4 lg:min-h-96 lg:h-[600px] pt-4 rounded-tl-3xl rounded-br-3xl">
      ...
      >
        <iframe
          ...
          className="border-none w-full lg:h-full min-h-64 rounded-tl-2xl rounded-br-2xl"
          allowFullScreen
          loading="lazy"
